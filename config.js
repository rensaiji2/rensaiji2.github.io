// ===== TEAM CONFIGURATION =====
// Edit this file with your team settings, then save and refresh the page

const TEAM_CONFIG = {
  // Your name (required)
  userName: "",

  // Team ID - everyone on your team uses the same ID (required)
  teamId: "",
  ...
  githubToken: "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",
